...
{
    const char* harcoded_name=my_username();
    char* loaded_name=malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(harcoded_name,loaded_name,"Names should match");
}
